...
echo $form->multiSelectList($element, get_class($element) . '[' . $side . '_complications]', $side . '_complications', 'id', CHtml::listData($complications,'id','name'), $element->et_ophtrintravitinjection_complicat_complicat_defaults, $html_options)?>
